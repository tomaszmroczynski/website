...
const SliderflatGorlice = () => {
  const content = [
    ...
    },
    {
      ...
      //button: "More Detail",
      //link: "/#",
      image: "./img/flatGorlice/6.webp",
    },    {
      title: <Trans i18nKey={"mainpictures2.title3"}></Trans>,
      description: <Trans i18nKey={"mainpictures2.desc3"}></Trans>,
      //button: "More Detail",
      //link: "/#",
      image: "./img/flatGorlice/7.webp",
    },    {
      title: <Trans i18nKey={"mainpictures2.title3"}></Trans>,
      description: <Trans i18nKey={"mainpictures2.desc3"}></Trans>,
      //button: "More Detail",
      //link: "/#",
      image: "./img/flatGorlice/8.webp",
    },
  ];
